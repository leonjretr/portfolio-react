...
const AboutText = () => {
    ...
    return (
        <div className={"text-justify font-poppinsFont text-sm md:text-base lg:text-lg font-medium dark:font-normal"}>
            ...
            className={"text-cyan-600 dark:text-cyan-500"}>Python, C++, C#, JavaScript and even Visual Basic. </span>
            For the past 6 months, I’ve been focusing on React and web development,
            and my primary goal is a <span className={"text-cyan-600 dark:text-cyan-500"}>React developer role</span> on
