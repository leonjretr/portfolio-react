...
const IntroductionText = () => {
    ...
    return (
        <div className={"font-interFont dark:font-poppinsFont select-none mx-5 "}>
            ...
            <RandomText text={"front-end developer"} styling={"text-xl mob2:text-2xl md:text-3xl lg:text-4xl xl:text-5xl dark:lg:text-3xl dark:xl:text-4xl ml-5 mob1:ml-16 mob3:ml-36 md:ml-40 lg:ml-52 mt-5 font-bold"}/>
